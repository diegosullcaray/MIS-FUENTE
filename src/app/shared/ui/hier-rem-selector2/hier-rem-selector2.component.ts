...
@Component({
    ...
    templateUrl: './hier-rem-selector2.component.html',
    styleUrls: ['./hier-rem-selector2.component.scss']
})
export class HierRemSelector2Component implements OnInit {
    @Input('config') conf_hier: any;
    ...
    constructor(private antAdmin: ModSysAdminService){
        this.active = false;
        this.dataSource = [];
        this.selectedValues = [];
        this.curr_lvl = 0;
