...
describe('RiegosFenComponent', () => {
  ...
  it('should load rows without selecting KPI data automatically', () => {
    ...
    expect(component.filteredRows[0].district).toBe('Tarapoto');
    expect(component.selected).toBeNull();
    expect(service.getResultados).toHaveBeenCalledWith(0, '220901');
  });

  it('should show KPI data only after selecting a table row', () => {
    const row = { ubigeo: '220901', district: 'Tarapoto' } as any;
