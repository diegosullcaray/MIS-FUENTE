...
export class rankingMujerComponent implements OnInit {
    ...
    loadData() {
        ...
        this.antRep.getRegularTableResult("RS_RANK_MUJ_01", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate}).pipe(
        ...
        // Segunda Tabla
        this.antRep.getRegularTableResult("RS_RANK_MUJ_02", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate }).pipe(
        ...
        // Cuarta Tabla
        this.antRep.getRegularTableResult("RS_AGE_COM_03", { "tip_cod": tipcod, "cod_rel": codrel, "fecha": this.currentDate, "mode": 1, "fuga": fuga, "prop": prop,"nom":rang }).pipe(
            finalize(() => this.load4.next(true))
        ).subscribe(
