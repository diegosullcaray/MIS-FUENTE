...
export class poblacionMisionalComponent implements OnInit {
    ...
    loadData() {
        ...
        this.antRep.getRegularTableResult("pob_misi_02", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate, "prod": prod }).pipe(
        ...
        // Segunda Tabla
        this.antRep.getRegularTableResult("pob_misi_03", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate, "prod": prod}).pipe(
        ...
        // Tercera Tabla
        this.antRep.getRegularTableResult("pob_misi_04", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate, "prod": prod}).pipe(
        ...
        //cuarta tabla
        this.antRep.getRegularTableResult("pob_misi_01", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate, "prod": prod}).pipe(
            finalize(() => this.load2.next(true))
        ).subscribe(
