...
export const tableHeaders = [
    ...
    {
        label: 'Tiempo Apertura Cuenta',
        key: 'HTAPERCC',
        type: 'string'
    },
    {
        label: 'Cuenta Lic. Funcionamiento',
        key: 'HCTALICEF',
        type: 'string'
    },
